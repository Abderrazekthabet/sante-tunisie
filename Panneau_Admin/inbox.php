...
<head>
    <title>Panneau d'Administration | Inbox</title>
          ...
          <div class="navbar-collapse">
            ...
            <div class="collapsing-content">
              ...
              <ul class="nav navbar-nav">
                <li class="divided">
                  <a href="inbox.php" class="page-refresh"><i class="fa fa-refresh"></i></a>
...
<div>
    ...
    <div class="tile-body nopadding">
        ...
        <thead>
            <tr>
                <th>Nom</th>        <th>Email</th>        <th>Message</th> <th></th>
            </tr>
        </thead>
        <?php 
        $requete = $msg->afficherNonLu();
        ...
        <tr>
            ...
            <td><a href="config/messagerie.php?ident=<?php echo $id ?>" class="btn btn-green btn-xs">Lire le message</a></td>
        </tr> 
        <?php } ?>
        </table>
    </div>
    ...
    <div class="tile-body nopadding">
        ...
        <?php while ($resultat = mysql_fetch_array($req_msg_lu))
        {
        $nom = $resultat['nom'];
        $email = $resultat['email'];
        $message = $resultat['message'];
        ...
        <tr>
            ...
            <td><?php echo $email ?></td>
            <td><?php echo $message?></td>
            <td><a href="config/messagerie.php?supp=<?php echo $id ?>" id="deleteRow" class="btn btn-red btn-xs delete-row">Supprimer le message</a></td>
        </tr> 
        <?php } ?>
        </table>
    </div> 
...
else
{
    ...
    header("refresh:0;url=../Portail_pharmacie/login.html");
}
