...
<link href="web/css/style_patient.css" rel="stylesheet" type="text/css" media="all"/>
					  ...
					  <div class="menu">
						  <a class="toggleMenu" href="#"><img src="web/images/nav.png" alt="" /></a>
							<ul class="nav">
								...
								<li><a href="modifier_medecin.php?id_medecin=<?php echo $ligne['id_medecin'];?>" ><i><img src="web/images/settings.png" alt="" /></i>Paramètres</a></li>
              ...
              <div class="column_middle_grid1">
		         <div class="profile_picture">
                  <div class="column_middle_grid">
		        	<form method="POST"  action="ajouter_patient.php?id_medecin=<?php echo $ligne['id_medecin'];?>">
        Nom       : <br/><label> <input type="text" name="nom"          id="nom"       required = placeholder="saisir le nom"         /></label>*<br/>
	    Prenom    : <br/><label> <input type="text" name="prenom"       id="prenom"    required = placeholder="saisir le prenom"      /></label>*<br/>        
	    Maladie   : <br/><label> <input type="text" name="maladie"      id="maladie"   required = placeholder="saisir maladie"        /></label>*<br/>        
	    Medicament: <br/><label> <input type="text" name="medicament"   id="medicament"required = placeholder="saisir le medicament" /></label>*<br/>        
	    Dose      : <br/><label> <input type="text" name="dose"         id="dose"      required = placeholder="saisir dose"          /></label>*<br/> 
