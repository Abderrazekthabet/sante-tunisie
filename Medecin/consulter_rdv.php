...
<link href="web/css/style_rdv.css" rel="stylesheet" type="text/css" media="all"/>
...
<body>			       
	...
	<tr>
		...
		<td align="center" width=35%>Heur</td>
		<td align="center" width=35%>Commentaire</td>
		<td align="center" width=40%>Supprimer</td>
	</tr>
	<?php while ($ligne2 = mysql_fetch_array($result)) {?>
		<tr>
			<td  align="center">	<?php echo $ligne2['id_rdv']; ?>	</td>
			<td  align="center">	<?php echo $ligne2['date']; ?>	</td>
		    <td  align="center">	<?php echo $ligne2['heure']; ?>	</td>
			<td  align="center">
			<form method="post" action="commenter.php?id_rdv=<?php echo $ligne2['id_rdv'];?>&id_medecin=<?php echo $id_medecin ;?>" name="commenter">
             <input type="text" id="com" name="com" value="<?php echo $ligne2['commentaire']; ?>"/>
             <input type="submit"  />			 
            </form>
			</td>
			<td ><a href="suppression_rdv.php?id_rdv=<?php echo $ligne2['id_rdv'];?>&id_medecin=<?php echo $ligne['id_medecin'] ;?> ">supprimer</a></td>
		</tr>	
