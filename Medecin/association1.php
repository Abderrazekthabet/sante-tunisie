	    		 ...
	    		 <div class="menu_box">
	    		 	 <h3>Menu</h3>
	    		 	   <div class="menu_box_list">
				      		<ul>
						  		<li><a href="ajouter_articles1.php?id_medecin=<?php echo $ligne['id_medecin'];?>" target="_blank" class="events"><span>Articles</span><div class="clear"></div></a></li>
              ...
              <div class="column_middle_grid1">
			   <div class="profile_picture">
			    <div class="column_middle_grid">
		         <form method="post" action="association.php?id_medecin=<?php echo $ligne['id_medecin'];?>">
			<input type="text" id="nomRech" name="nomRech" placeholder="saisir le matricule d'association a rechercher" />
			<input type="submit" value="Rechercher" id="boutonRech"/>
