...
$requete2="SELECT * FROM `rdv` r INNER JOIN `medecin` m ON r.id_medecin=m.id_medecin   WHERE r.id_personne='$id' ";
...
header("location:rdv.php?id=".$ligneR['id_patient']);
}
?>
...
<tr>   
       ...
       <td>Date</td>
	   <td>Heure</td>
       <td>Commentaire de medecin</td></br></br></br>
</tr>
...
<tr>  
       ...
       <td><a href="medecin.php?id=<?php echo $ligne['id_patient'];?>&ida=<?php echo $ligne2['id_medecin'];?>"><?php echo $ligne2['nom']." ".$ligne2['prenom'];?></a></td>
       <td><?php echo $ligne2['specialite'];?></td>
	   <td><?php echo $ligne2['date'];?></td>
	   <td><?php echo $ligne2['heure'];?></td>
       <td><?php echo $ligne2['commentaire'];?></td>
