...
<script type="text/javascript" src="./js/Chart.js"></script>
 ...
 var page=1;
 var per_page=1;
 var items= $('.gh_liste_evenement').length;
 var page_last=Math.ceil(items/per_page);
 
 function setPage(page){
 $('.gh_liste_evenement').slice(0, page * per_page).hide();
 $('.gh_liste_evenement').slice(page * per_page - per_page , page * per_page).show();
 $('.gh_liste_evenement').slice(page * per_page).hide();
...
$an=$_POST['eve_year'];
$date=$an."-".$mo."-".$jr;
$requete2="SELECT * FROM `evenements` WHERE date='$date' and etat_admin='Validé' ";
}

if($type == "tous")
{
$requete2="SELECT * FROM `evenements` where etat_admin='Validé'  order by date asc  ";
}
...
<div class="listeeve">
	...
	<div class="gh_liste_evenement">
	<center>
	    <span><?php  echo $r=$r+1;?></span><p>Nom : <?php echo $ligne2['nom'];?></p></br><p>Théme : <?php echo $ligne2['theme'];?></p></br><p>Type : <?php echo $ligne2['type'];?></p></br><p>Organisé par :<a href="mailto:"<?php echo $ligne2['hote'];?>><?php echo $ligne2['hote'];?></a></p></br><p>Lieu : <?php echo $ligne2['lieu'];?></p></br><p>Date : <?php echo $ligne2['date'];?></p></br><p>Description : </br><?php echo $ligne2['description'];?></p>
		</center>
	</div>
	</br></br></br>
	<?php   }  ?>
