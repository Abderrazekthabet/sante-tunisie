...
//$query = "select a.*, ass.nom from articles a join associations ass on a.auteur = ass.idAssociation;";
$query = "select * from articles where etat_admin = 'Validé';";
	  ...
	  <div class="main">  
		...
		<div class="postExcerpt text">
                    ...
                    <div class="postExcerptInner">
                        ...
                        <br><br><br>						
						<h2 class="h2mail">Auteur: <?php echo $ligne['auteur'];?></h2>
					</div>
	   </div>
			   <?php }	?>
</div>
